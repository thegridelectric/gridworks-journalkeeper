...
class LogLevel(GwStrEnum):
    ...
    def default(cls) -> "LogLevel":
        """
        Returns default value (in this case Info)
        """
        return cls.Info
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (log.level)
        """
        return "log.level"
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "Info".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a LogLevel enum to send in seriliazed messages.
