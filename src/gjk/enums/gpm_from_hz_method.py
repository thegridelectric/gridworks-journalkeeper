...
class GpmFromHzMethod(GwStrEnum):
    ...
    def default(cls) -> "GpmFromHzMethod":
        """
        Returns default value (in this case Constant)
        """
        return cls.Constant
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (gpm.from.hz.method)
        """
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "Constant".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a GpmFromHzMethod enum to send in seriliazed messages.
