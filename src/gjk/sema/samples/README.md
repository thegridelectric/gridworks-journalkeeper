...
Coverage: **35 of 63** seeded type versions have a sample.

Seeded type versions lacking a sample (no `examples:`):

- `atn.bid.002`
- `channel.config.000`
- `energy.instruction.000`
- `flo.params.house0.007`
- `fsm.full.report.001`
- `glitch.000`
...
- `ticklist.hall.101`
- `ticklist.hall.report.000`
- `ticklist.reed.101`
- `ticklist.reed.report.000`
