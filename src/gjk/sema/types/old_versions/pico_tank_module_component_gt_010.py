...
class PicoTankModuleComponentGt010(SemaType):
    """Sema: https://schemas.electricity.works/types/pico.tank.module.component.gt/010"""
    ...
    def check_axiom_1(self) -> "PicoTankModuleComponentGt010":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_2(self) -> "PicoTankModuleComponentGt010":
        """
    ...
    def upgrade(self) -> PicoTankModuleComponentGt:
        """Baseline runtime version (no prior version tracked)."""
        data = self.model_dump()
        data["version"] = "011"
        return PicoTankModuleComponentGt.model_validate(data)
