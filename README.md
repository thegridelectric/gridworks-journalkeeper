...
Sema — the versioned vocabulary of JSON-Schema contracts governing all
GridWorks message boundaries — is canonical at
[`thegridelectric/sema`](https://github.com/thegridelectric/sema) (spec at
`spec/primary.md`); schema ids live under the
`https://schemas.electricity.works` namespace. See `src/gjk/sema/README.md`
