...
install_s  = pendulum.datetime(2023, 1, 12, 0, 0 , 0, tz='America/New_York').int_timestamp

start_s = day_offset * 3600 * 24 + install_s
duration_hrs = days * 24 + 1
print(str_from_ms(start_s * 1000))

p = JournalKeeperHack(Settings(_env_file=dotenv.find_dotenv()), short_alias='oak')
